...
const createValidationSchema = () => {
    return [
        ...
        check.body('code').notEmpty({ignore_whitespace: true}).withMessage(requiredResponse("code")).bail()
            .isString().withMessage(notValidResponse("code")).bail().customSanitizer(v => safeString(v)),
